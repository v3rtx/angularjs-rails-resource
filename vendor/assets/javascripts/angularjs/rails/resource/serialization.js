...
angular.module('rails').factory('railsSerializer', ['$injector', 'RailsInflector', 'RailsResourceInjector', function ($injector, RailsInflector, RailsResourceInjector) {
    ...
    function railsSerializer(options, customizer) {
        ...
        /**
         * Accepts a variable list of attribute names to exclude from JSON serialization and deserialization.
         *
        ...
        /**
         * Accepts a variable list of attribute names that should be included in JSON serialization and deserialization.
         ...
         */
        Serializer.prototype.isExcluded = function (attributeName) {
        ...
        Serializer.prototype.getSerializedAttributeName = function (attributeName) {
            ...
            if (this.isExcluded(attributeName) || this.isExcluded(mappedName)) {
                return undefined;
            }
        ...
        Serializer.prototype.getDeserializedAttributeName = function (attributeName) {
            ...
            if (this.isExcluded(attributeName) || this.isExcluded(camelizedName)) {
                return undefined;
            }
